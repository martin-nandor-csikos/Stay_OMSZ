...
$classes = ($active ?? false)
            ...
            : 'block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium text-gray-500 dark:text-gray-100 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 dark:focus:text-gray-200 dark:focus:bg-gray-700 dark:focus:border-gray-200 transition duration-150 ease-in-out';
@endphp
